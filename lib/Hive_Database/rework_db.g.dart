...
part of 'rework_db.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ReworkModelAdapter extends TypeAdapter<ReworkModel> {
  @override
  final int typeId = 12;

  @override
  ReworkModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ReworkModel obj) {
    writer
      ..writeByte(26)
      ..writeByte(0)
