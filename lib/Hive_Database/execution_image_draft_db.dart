...
part 'execution_image_draft_db.g.dart';

// Persists in-progress (not-yet-submitted) execution image captures so that
// closing the upload screen before hitting Submit does not lose already
// captured images. One record per plan/village/print location.
@HiveType(typeId: 15)
class ExecutionImageDraft {
  @HiveField(0)
  String draftKey;
  ...
  // Index order matches the 7 capture slots used on the upload screen:
  // 0=Clean 1=WB 2=Spray 3=Near 4=Far 5=New6 6=New7
