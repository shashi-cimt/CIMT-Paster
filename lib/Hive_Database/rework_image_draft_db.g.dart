...
part of 'rework_image_draft_db.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ReworkImageDraftAdapter extends TypeAdapter<ReworkImageDraft> {
  @override
  final int typeId = 16;

  @override
  ReworkImageDraft read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ReworkImageDraft(
      draftKey: fields[0] as String,
      ServerPlanId: fields[1] as String?,
      PlanCode: fields[2] as String?,
      VillageCode: fields[3] as String?,
      printId: fields[4] as String?,
  ...
  @override
  void write(BinaryWriter writer, ReworkImageDraft obj) {
    writer
      ..writeByte(29)
      ..writeByte(0)
      ..write(obj.draftKey)
  ...
  bool operator ==(Object other) =>
      ...
      other is ReworkImageDraftAdapter &&
