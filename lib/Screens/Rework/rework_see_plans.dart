...
class _ReworkScreenState extends ConsumerState<ReworkScreen> {
  ...
  Future<void> _refreshPlans() async {
    try {
      ...
      final _ = await ref.refresh(reloadReworkPlansProvider(true).future);
  ...
  Future<Map<String, Map<String, dynamic>>> _filterGroupsWithDisplayBalance(
    ...
    final offlineCountsMap = await ReworkBalanceCountChangeRepository().getAllOfflineCountsMap();
                ...
                child: plansState.when(
                  data: (plans) {
                    ...
                    return FutureBuilder<Map<String, Map<String, dynamic>>>(
                      key: ValueKey(
                        '${_processedGroupedPlans!.length}_${reworkOfflineCountRefresh}_${isRefreshing}_$_searchQuery',
                      ),
